...
<div class="bg-slate-300 min-h-screen flex flex-col items-center pb-8">
    <header class="flex justify-between w-full p-2 border-b mb-4 items-center">
        <!-- Main menu section with icon -->
        <div class="flex items-center">
            <!-- Add your .png icon here -->
            <img src="/favicon.png" alt="Menu Icon" class="w-20 h-20 mr-4">
